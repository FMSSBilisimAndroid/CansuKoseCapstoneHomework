...
class MainViewFlightModel (var travelRepository : TravelRepository ) : ViewModel(){

    var travelsFlight: MutableLiveData<List<Travel>> = MutableLiveData<List<Travel>>()
